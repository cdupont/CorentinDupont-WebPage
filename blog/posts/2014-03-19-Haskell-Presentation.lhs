...
Among the 4, only the higher order functions were covered in this lecture.
...
How can we make an impure program (a pure, effectless program would not be very useful), using a pure language?
...
However, it will call your pure instructions through the main, and react to IO programmed by IO functions that are passed through the World structure.
